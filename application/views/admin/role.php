<div class="content-header row">
          <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
              <div class="col-12">
                <h2 class="content-header-title float-left mb-0">Role Akun</h2>
          ...
          <div class="content-header-right text-md-right col-md-3 col-12 d-md-block d-none">
            <div class="form-group breadcrum-right">
              <!-- <button type="button" class="btn btn-outline-primary block btn-lg waves-effect waves-light" data-toggle="modal" data-target="#default">
                ...
                <a href="<?= site_url('dashboard/tambah_role/'); ?>" class="btn-icon btn btn-primary btn-round btn-sm dropdown-toggle waves-effect waves-light" type="button">Tambah Role</a>
            </div>
          </div>
        </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover-animation mb-0">
                            <thead>
                              ...
                              <tbody>
                        <?php $no=1;foreach ($role as $key) { ?>
                                <tr>
                                  <th scope="row"><?=$no?></th>
                                  <td><?=$key->role;?></td>
                                  <td><?=$key->date;?></td>
                                  <td><a href=""><i class="fa-trash-o">Hapus</i></a></td>
                                </tr>
                        <?php  $no++;} ?>
                            </tbody>
                        </table>
