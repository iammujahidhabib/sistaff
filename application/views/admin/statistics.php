...
<div class="content-header row">
    <div class="content-area__content col-sm-12 card">
        <div class="card-body">
            <div class="row">
                <div class="col-xl-12 col-md-12 col-sm-12">
                    <h3>Your Statistics</h3>
                    <div id="chart">
                        <canvas id="myChartNilai" style="max-height:400px"></canvas>
                    </div>
                </div>
                ...
                <div class="col-xl-3 col-md-3 col-sm-3">
                    <br>
                    <a href="#"><img src="<?php echo base_url('asset/btn_export.png'); ?>" style="width:100%"></a>
                </div>
            </div>
        </div>
    </div>
