                    ...
                    <div class="table-responsive">
                        ...
                        <?php $no=1;foreach ($kategori as $key) { ?>
                                <tr>
                                  ...
                                  <td><?=$key->kategori;?></td>
                                  <td><?=$key->date;?></td>
                                  <td><a class="btn btn-danger btn-sm" style="color: white" onclick="confirm_delete(<?=$key->id_kategori;?>)"><i class="fa fa-trash-o"> </i>Hapus</a></td>
                                </tr>
                        <?php  $no++;} ?>
                            </tbody>
                        </table>
...
<script type="text/javascript">
  function confirm_delete(id) {
    ...
    if (con == true) {
        window.location = url+"dashboard/delete_kategori/"+id;
        console.log('Yakin');
    }else{
        console.log('Tidak');
    }
