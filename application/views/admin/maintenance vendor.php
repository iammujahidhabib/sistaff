          ...
          <div class="content-header-right text-md-right col-md-3 col-12 d-md-block d-none">
            <div class="form-group breadcrum-right">
              <!-- <button type="button" class="btn btn-outline-primary block btn-lg waves-effect waves-light" data-toggle="modal" data-target="#default">
                ...
                <a href="<?= site_url('maintenance/tambah_vendor/'); ?>" class="btn-icon btn btn-primary btn-round btn-sm dropdown-toggle waves-effect waves-light" type="button">Tambah Vendor</a>
            </div>
          </div>
        </div>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Maintenance Vendor</h4>
            </div>
                        ...
                        <table class="table table-hover-animation mb-0">
                            <thead>
                              ...
                              <tbody>
                                <tr>
                                  <th scope="row">1</th>
                                  <td>Asus Service Center</td>
                                  <td>service@asus.com</td>
                                  <td>0821372209</td>
                                  <td>BEC lt 2</td>
                                </tr>
                                <tr>
                                  ...
                                  <td>service@samsung.com</td>
                                  <td>0821372209</td>
                                  <td>BEC lt 3</td>
                                </tr>
                                <tr>
                                  <th scope="row">1</th>
                                  <td>Bengkel Mobil Jaya</td>
                                  <td>service@jayamobil.com</td>
                                  <td>082137223209</td>
                                  <td>Jl Soekarno Hatta no 201, Bandung</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
