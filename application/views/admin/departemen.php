    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Tabel Departemen</h4>
            </div>
                    ...
                    <div class="table-responsive">
                        ...
                        <?php $no=1;foreach ($departemen as $key) { ?>
                                <tr>
                                  ...
                                  <td><?=$key->date;?></td>
                                  <td><a  class="btn btn-danger btn-sm" style="color: white"onclick="confirm_delete(<?=$key->id_departemen;?>)"><i class="fa fa-trash-o">Hapus</i></a></td>
                                </tr>
                        <?php  $no++;} ?>
                            </tbody>
                        </table>
...
<script type="text/javascript">
  function confirm_delete(id) {
    ...
    if (con == true) {
        window.location = url+"dashboard/delete_departemen/"+id;
        console.log('Yakin');
    }else{
        console.log('Tidak');
    }
