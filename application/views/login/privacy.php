<div class="container" style="max-height: 50vh; overflow: auto;">
  <div class="row">
    <div class="col center-block-e">
      <div class="login-form">
        <div class="login-form-inner">
          <?php $gl = $this->session->flashdata('globalmsg'); ?>
          <?php if(!empty($gl)) :?>
            <div class="alert alert-success"><b><span class="glyphicon glyphicon-ok"></span></b> <?= $this->session->flashdata('globalmsg') ?></div> 
          <?php endif; ?>
            ...
            <p class="decent-margin align-center"><a href="<?= site_url() ?>"> <?= lang("ctn_177") ?></a></p>
          </div>
        </div>
    </div>
  </div>
